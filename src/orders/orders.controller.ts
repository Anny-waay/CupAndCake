...
export class OrdersController {
  ...
  @ApiOkResponse({description: 'Orders was successfully received.'})
  @Get()
  ...
  @ApiCreatedResponse({description: 'Order was successfully created.'})
  ...
  @ApiOkResponse({description: 'Order status was successfully changed.'})
